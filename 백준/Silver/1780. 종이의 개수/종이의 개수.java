...
public class Main {
    ...
    private static void partition(int m, int n, int k) {
        if (check(m, n, k)) {
            ...
            partition(m, n, k / 3);
            partition(m, n + k / 3, k / 3);
            partition(m, n + 2 * k / 3, k / 3);
            partition(m + k / 3, n, k / 3);
            partition(m + k / 3, n + k / 3, k / 3);
            partition(m + k / 3, n + 2 * k / 3, k / 3);
            partition(m + 2 * k / 3, n, k / 3);
            partition(m + 2 * k / 3, n + k / 3, k / 3);
            partition(m + 2 * k / 3, n + 2 * k / 3, k / 3);
        }
    }
